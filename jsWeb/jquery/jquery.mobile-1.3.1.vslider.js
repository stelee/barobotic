...
$.widget( "mobile.vslider", $.mobile.widget, {
	options: {
		...
		trackTheme: null,
		disabled: false,
		initSelector: "input[data-type='vslider'], :jqmData(type='vslider'), :jqmData(role='vslider')",
		mini: false
	},
	...
	_create: function() {
		...
		var self = this,
			...
			sliderOrientation = control.attr( "sliderOrientation") || "vertical",
			...
			valuebg = control.jqmData("highlight") && cType != "select" ? (function() {
				...
				if(sliderOrientation=="verticalInverted"){
					bg.className = 'ui-btn-corner-all ui-btn-down-'+trackTheme;
					slider.addClass('ui-slider-bg ui-btn-active');
				}else
				{
		...
		if(control.jqmData("highlight")&&sliderOrientation=="verticalInverted"){
			slider.addClass('ui-slider-bg ui-btn-active');
		}
		...
		control.wrap( "<div class='ui-slider ui-slider-container-vertical'></div>" )
		...
		control
			...
			.addClass('ui-slider-input-vertical')
			.change( function() {
		...
		control.trigger( "create", null, this._getCreateEventData());
	},
